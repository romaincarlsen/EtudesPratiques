...
\FigureEPS{h,t,b,p}{4cm}{./img/mvc.eps}{Schéma modèle MVC (Model View Controller)}{fig:mvc}
...
\FigureEPS{h,t,b,p}{4cm}{./img/plateau.eps}{Damier correspondant à la fonction de coût}{fig:coût}
